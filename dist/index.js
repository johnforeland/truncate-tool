...
const tool = new main_1.TruncateTool();
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.TruncateTool = void 0;
const action_inputs_1 = __nccwpck_require__(437);
class TruncateTool {
    inputs;
    text;
    lines;
    constructor() {
        this.inputs = (0, action_inputs_1.getInputs)();
...
exports.TruncateTool = TruncateTool;
